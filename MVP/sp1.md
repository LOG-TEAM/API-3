...
Limpeza e padronização dos dados utilizando Python, garantindo maior qualidade e confiabilidade da base.

Análise exploratória descritiva, permitindo analisar as fiscalizações por equipe, região e tipo de inspeção.

Mapeamento geográfico e identificação de clusters, possibilitando compreender onde existe maior concentração de locais fiscalizados.

Cálculo da matriz de distâncias e tempos de deslocamento utilizando Python, preparando os dados que serão utilizados posteriormente em um modelo de otimização.
